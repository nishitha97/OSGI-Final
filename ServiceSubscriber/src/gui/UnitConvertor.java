...
public class UnitConvertor extends JFrame {
	...
	public UnitConvertor(LengthConvertManager lengthConvertManager, TimeConvertManager timeConvertManager,
			WeightConvertManager weightConvert, TemperatureConvertManager temperatureConvert) {
	...
	private void initialize() {
		...
		btnGram.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionWeightPublish.convertGramToKilogram(Double.parseDouble(txtInput.getText()));
		...
		kiloGram.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionWeightPublish.convertKilogramToGram(Double.parseDouble(txtInput.getText()));
		...
		btnMetres.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionLenghtPublish.convertCMToM(Double.parseDouble(txtInput.getText()));
		...
		centimeters.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionLenghtPublish.convertMToCM(Double.parseDouble(txtInput.getText()));
		...
		inches.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionLenghtPublish.convertFeetToInches(Double.parseDouble(txtInput.getText()));
		...
		feet.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionLenghtPublish.convertInchesToFeet(Double.parseDouble(txtInput.getText()));
		...
		kilometers.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionLenghtPublish.convertMToKM(Double.parseDouble(txtInput.getText()));
		...
		meters.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionLenghtPublish.convertKMToM(Double.parseDouble(txtInput.getText()));
				// lblAnswer.setText(String.valueOf(ans) + " m");
			}
		});
		...
		celcius.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionTemperaturePublish.convertCelciusToFarenheight(Double.parseDouble(txtInput.getText()));
		...
		farenheight.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				// double ans =
				// conversionTemperaturePublish.convertFarenheightToCelcius(Double.parseDouble(txtInput.getText()));
